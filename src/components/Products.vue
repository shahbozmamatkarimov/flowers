<template>
  <main @mousedown="toggleFunc" class="pb-20 md:mt-12 mt-11 w-full overflow-y-auto max-h-screen" @scroll="scrolling">
    <nav class="sticky top-2 py-3 z-10 bg-white shadow-lg">
      <form class="sm:mx-10 mx-2">
        <div class="flex">
          ...
          <p @click="toggle.toggleFilter = !toggle.toggleFilter"
            class="flex-shrink-0 z-10 inline-flex sm:hidden items-center py-1 px-4 text-sm font-medium text-center border border-gray-300 rounded-l-lg hover:bg-gray-200 outline-none">
